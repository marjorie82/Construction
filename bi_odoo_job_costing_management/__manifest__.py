...
""",
    ...
    'depends': ['base','sale_management','project','purchase','account','hr_timesheet','note','sale_stock','stock','hr_timesheet_attendance','bi_subtask','bi_material_purchase_requisitions'],  #
    'data': [
